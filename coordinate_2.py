...
RESULTS_DIR = "satis_conv_search_configuration"; os.makedirs(RESULTS_DIR, exist_ok=True)
...
INITIAL_CONFIG = {"conv_filters": (64, 128), "kernel_size": 5, "dilation_rate": 1, "lstm_units": 64, "dropout_rate": 0.1, "learning_rate": 1e-3}
...
def build_satis_model(input_shape, conv_filters=(64, 128), kernel_size=5, dilation_rate=1, lstm_units=64, dropout_rate=0.1, learning_rate=1e-3):
